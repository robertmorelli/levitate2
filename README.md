...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| identity | 29% | 81% | 89% | 17% | 26% | 17% | 40% | 76% | 77% |
| gaussian | 29% | 17% | 55% | 17% | 29% | 17% | 17% | 75% | 80% |
| causal | 26% | 35% | 59% | 17% | 26% | 17% | 22% | 74% | 82% |
| uniform | 29% | 42% | 69% | 17% | 29% | 17% | 17% | 75% | 80% |
| differential | 71% | 83% | **93%** | 0% | 70% | 0% | 32% | 68% | 89% |
| ema | 29% | 52% | 69% | 17% | 29% | 17% | 27% | 71% | 85% |
...
| conv \ alg | global_residual | per_token | arithmetic | arithmetic_opt | momentum | dominant_prefix | delta_decode | amplitude_sort | conv_residual |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| identity | **+57%** | **+2%** | -8% | **+83%** | **+63%** | **+49%** | **+43%** | **+2%** | **+6%** |
| gaussian | **+60%** | **+61%** | **+24%** | **+56%** | **+60%** | **+36%** | **+8%** | **+5%** | **+1%** |
| causal | **+52%** | **+56%** | **+22%** | **+67%** | **+55%** | **+50%** | **+63%** | **+1%** | -3% |
| uniform | **+58%** | **+42%** | **+12%** | **+60%** | **+57%** | **+45%** | **+67%** | **+2%** | **+1%** |
| differential | -6% | -8% | **+5%** | 0% | -6% | 0% | **+66%** | **+10%** | **+5%** |
| ema | **+54%** | **+24%** | **+13%** | **+83%** | **+54%** | **+57%** | **+57%** | **+7%** | **+1%** |
...
| conv \ alg | global_residual | per_token | arithmetic | arithmetic_opt | momentum | dominant_prefix | delta_decode | amplitude_sort | conv_residual |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| identity | 35% | 39% | 33% | 15% | 42% | 17% | 28% | 48% | 37% |
| gaussian | 38% | 17% | 17% | 15% | 40% | 17% | 19% | 56% | 50% |
| causal | 29% | 17% | 17% | 15% | 34% | 17% | 39% | 56% | 51% |
| uniform | 38% | 17% | 17% | 15% | 40% | 17% | 19% | 54% | 50% |
| differential | 17% | 32% | 34% | 0% | 17% | 0% | 38% | 54% | 32% |
| ema | 31% | 17% | 17% | 15% | 38% | 17% | 37% | **70%** | 58% |
...
| conv \ alg | global_residual | per_token | arithmetic | arithmetic_opt | momentum | dominant_prefix | delta_decode | amplitude_sort | conv_residual |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| identity | 73% | 92% | 78% | **100%** | 76% | 50% | 80% | 75% | 83% |
| gaussian | 75% | 76% | 78% | 70% | 77% | 50% | 20% | 76% | 80% |
| causal | 74% | 86% | 84% | 95% | 78% | 31% | 80% | 77% | 84% |
| uniform | 78% | 80% | 78% | 66% | 78% | 50% | 80% | 77% | 80% |
| differential | 66% | 80% | 91% | 0% | 66% | 0% | 90% | 73% | 96% |
| ema | 69% | 85% | 83% | 96% | 74% | 77% | 84% | 82% | 84% |

### bare → described delta

| conv \ alg | global_residual | per_token | arithmetic | arithmetic_opt | momentum | dominant_prefix | delta_decode | amplitude_sort | conv_residual |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| identity | **+38%** | **+53%** | **+45%** | **+85%** | **+33%** | **+33%** | **+52%** | **+27%** | **+46%** |
| gaussian | **+37%** | **+59%** | **+60%** | **+55%** | **+37%** | **+33%** | **+1%** | **+20%** | **+30%** |
| causal | **+45%** | **+68%** | **+66%** | **+80%** | **+44%** | **+13%** | **+42%** | **+21%** | **+33%** |
| uniform | **+40%** | **+63%** | **+61%** | **+52%** | **+38%** | **+33%** | **+61%** | **+23%** | **+30%** |
| differential | **+49%** | **+48%** | **+57%** | 0% | **+49%** | 0% | **+52%** | **+18%** | **+64%** |
| ema | **+38%** | **+67%** | **+65%** | **+81%** | **+36%** | **+60%** | **+47%** | **+12%** | **+25%** |

## summary

| provider | bare avg best | described avg best |
| --- | --- | --- |
| gemini | 93% (`differential × arithmetic`) | 100% (`identity × arithmetic_opt`) |
| ollama | 64% (`identity × per_token`) | 100% (`identity × arithmetic_opt`) |
| openai | 70% (`ema × amplitude_sort`) | 100% (`identity × arithmetic_opt`) |
